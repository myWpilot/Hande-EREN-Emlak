  ...
  return (
    '<article class="listing-card reveal' + (showStatusBadge ? ' listing-card--inactive' : '') + '">' +
      ...
      '<div class="listing-card__body">' +
        ...
        '<span style="display:inline-flex;align-items:center;gap:4px;font-family:var(--font-mono);font-size:0.68rem;font-weight:700;color:#0F6631;background:#D9F5E4;border:1px solid #34A65F;border-radius:20px;padding:3px 9px;margin:6px 0 10px 8px;vertical-align:middle;line-height:1;"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="width:11px;height:11px;flex-shrink:0;display:block;"><path d="M9 12l2 2 4-4"/><path d="M12 2l7 3v6c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V5z"/></svg>EİDS Onaylı</span>' +
